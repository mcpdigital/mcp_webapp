      ...
      <div className="text-center">
        <div className="wrapper pt-10">
          ...
          <div className="box-border max-w-7xl mx-4 sm:columns-1 md:columns-2 lg:columns-3 xl:columns-4">
            <article className="mb-4 break-inside-avoid p-6 rounded-xl bg-white dark:bg-slate-800 flex flex-col bg-clip-border">
              <div className="flex pb-6 items-center justify-between">
                <div className="flex">
                  ...
                  <div className="flex flex-col">
                    <div>
                      <a
                        className="inline-block text-lg bold dark:text-white"
                        href="#"
                      >
                        Wade Warren
                      </a>
              ...
              <div className="py-4">
                <a className="inline-flex items-center" href="#">
                  ...
                  <span className="text-lg bold">34</span>
                </a>
              </div>
              <div className="relative">
                ...
                <span className="flex absolute right-3 top-2/4 -mt-3 items-center">
                  <svg className="mr-2 h-[26px] w-[26px]" viewBox="0 0 24 24">
                    <path
                      fill="currentColor"
                  ...
                  <svg
                    className="fill-blue-500 dark:fill-slate-50 h-[24px] w-[24px]"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <div className="media-body">
                    ...
                    <div className="mt-2 flex items-center">
                      ...
                      >
                        <span className="mr-2">
                          <svg
                            className="fill-rose-600 dark:fill-rose-400 h-[22px] w-[22px]"
                            viewBox="0 0 24 24"
                          >
                            <path d="M12,21.35L10.55,20.03C5.4,15.36 2,12.27 2,8.5C2,5.41 4.42,3 7.5,3C9.24,3 10.91,3.81 12,5.08C13.09,3.81 14.76,3 16.5,3C19.58,3 22,5.41 22,8.5C22,12.27 18.6,15.36 13.45,20.03L12,21.35Z"></path>
                          </svg>
            ...
            <article className="mb-4 break-inside-avoid p-6 rounded-xl bg-white dark:bg-slate-800 flex flex-col bg-clip-border">
              ...
              <div className="py-4">
                <a className="flex" href="#">
                  <Image
                    className="min-w-content max-w-full rounded-lg"
              ...
              <div className="py-4">
                <a className="inline-flex items-center" href="#">
                  <span className="mr-2">
                    <svg
                      className="fill-rose-600 dark:fill-rose-400 h-[24px] w-[24px]"
                      viewBox="0 0 24 24"
                    >
                      <path d="M12,21.35L10.55,20.03C5.4,15.36 2,12.27 2,8.5C2,5.41 4.42,3 7.5,3C9.24,3 10.91,3.81 12,5.08C13.09,3.81 14.76,3 16.5,3C19.58,3 22,5.41 22,8.5C22,12.27 18.6,15.36 13.45,20.03L12,21.35Z"></path>
                    </svg>
            ...
            <article className="mb-4 break-inside-avoid rounded-xl bg-white dark:bg-slate-800 flex flex-col bg-clip-border">
